...
const AppBar = styled(MuiAppBar, {
  ...
  ...(open && { //When open
    background: 'linear-gradient(45deg, #2D9596 10%, #161A30 100%)',
...
const Drawer = styled(MuiDrawer, {
  ...
  "& .MuiDrawer-paper": {
    ...
    ...(!open && {
      background: 'linear-gradient(45deg, #2D9596 10%, #31304D 90%)',
      color: 'white',
      overflowX: "hidden",
      transition: theme.transitions.create("width", {
        easing: theme.transitions.easing.sharp,
            ...
            <Grid container spacing={4}> 
              ...
              <Grid item xs={12} md={8} lg={4} mt={4} mb={2} >
                <CardWithPhoto
                  ...
                  description2="."
                  description3="Jan 2024: 1D CNN, ESP32, ArduinoIDE Community Portal, Topic Wise content, Animations, Responsive, Dark Mode"
