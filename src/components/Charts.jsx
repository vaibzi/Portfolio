...
const experienceData = [1,2, 2, 2, 1, 3, 3, 3 ];
const proficiencyData = [1, 2, 2, 2, 3, 2, 3, 3 ];
const xLabels = [
  'SQL',
  'MongoDB',
  'Express.js',
...
export function SimpleBarChart() {
  return (
    <BarChart 
      ...
      height={270}
      series={[
        { data: proficiencyData, label: 'Proficiency (0 to 3)', id: 'proficiencyId' },
...
const Prog_proficiencyData = [2, 3, 1, 2];
const Prog_xLabels = [
  'C',
  'C++',
  'Java',
...
export function ProgBarChart() {
  return (
    <BarChart 
      ...
      height={270}
      series={[
        { data: Prog_proficiencyData, label: 'Proficiency (0 to 3)', id: 'ProgproficiencyId' },
      ]}
...
const pData_WebDev = [0, 1, 5, 4, 4, 4, 2, 6];
...
const pData_Core = [0, 3, 3, 2, 1, 3, 1, 2];
const xLabels_Core = [
  'Hacking',
  'DBMS',
  'OS',
